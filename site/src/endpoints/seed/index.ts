...
// Only the nav globals are reset here (both have navItems). Kept as a literal
// tuple so `slug` narrows to 'header' | 'footer' — a widened GlobalSlug[] would
// pull in globals without navItems (e.g. 'homepage') and break the reset's type.
